...
(() => {
  ...
  var require_code = __commonJS({
    "code.ts"(exports) {
      var EXPIRY_DATE = /* @__PURE__ */ new Date("2026-03-07T00:00:00+09:00");
      if (/* @__PURE__ */ new Date() >= EXPIRY_DATE) {
      ...
      function importPsdData(data) {
        return __async(this, null, function* () {
          ...
          yield createNodesWithClipping(data.nodes, mainFrame);
          figma.viewport.scrollAndZoomIntoView([mainFrame]);
          figma.currentPage.selection = [mainFrame];
          console.log(`Import complete: ${processedNodes} nodes processed`);
        });
      }
      function createNodesWithClipping(nodes, parent) {
        return __async(this, null, function* () {
          let i = 0;
          while (i < nodes.length) {
            ...
            if (!currentNode.clipping) {
              ...
              if (clippingNodes.length > 0) {
                yield createClippingGroup(currentNode, clippingNodes, parent);
                i = j;
              } else {
                yield createNode(currentNode, parent);
                i++;
              }
            } else {
              yield createNode(currentNode, parent);
      ...
      function createClippingGroup(baseNode, clippingNodes, parent) {
        return __async(this, null, function* () {
          ...
          clipFrame.fills = [];
          var baseCreated = yield createNodeInFrame(baseNode, clipFrame, 0, 0);
          if (baseCreated) {
          ...
          for (var cj = 0; cj < clippingNodes.length; cj++) {
            ...
            yield createNodeInFrame(clipNode, clipFrame, offsetX, offsetY);
          }
        });
      }
      function createNodeInFrame(nodeData, parent, offsetX, offsetY) {
        return __async(this, null, function* () {
          const node = yield createNodeBase(nodeData, parent);
          if (node) {
            node.x = offsetX;
            node.y = offsetY;
      ...
      function createNode(nodeData, parent) {
        return __async(this, null, function* () {
          processedNodes++;
          ...
          if (nodeData.mask && nodeData.mask.enabled) {
            node = yield createMaskedNode(nodeData, parent);
          } else {
            node = yield createNodeBase(nodeData, parent);
          }
          if (node) {
            node.name = nodeData.name;
            node.visible = nodeData.visible;
      ...
      function createNodeBase(nodeData, parent) {
        return __async(this, null, function* () {
          let node = null;
          switch (nodeData.type) {
            case "GROUP":
              node = yield createGroup(nodeData, parent);
              break;
            case "TEXT":
              node = yield createText(nodeData, parent);
              break;
            case "RECTANGLE":
            case "VECTOR":
            default:
              node = yield createRectangle(nodeData, parent);
              break;
          }
          return node;
        });
      }
      function createMaskedNode(nodeData, parent) {
        return __async(this, null, function* () {
          ...
          if (defaultColor === 255) {
            ...
            var contentNode2 = yield createNodeBase(contentNodeData2, parent);
            return contentNode2;
          }
          ...
          if (maskBounds.width <= 0 || maskBounds.height <= 0) {
            ...
            return yield createNodeBase(contentNodeData3, parent);
          }
          ...
          var contentNode = yield createNodeBase(contentNodeData, maskFrame);
          if (contentNode) {
      ...
      function createGroup(nodeData, parent) {
        return __async(this, null, function* () {
          ...
          if (hasClipping) {
            ...
            yield createNodesWithClipping(adjustedChildren, frame);
            return frame;
          }
          const children = [];
          for (const childData of nodeData.children) {
            const child = yield createNode(childData, parent);
            if (child) {
              children.push(child);
            }
          }
      ...
      function tryLoadFont(family, style) {
        return __async(this, null, function* () {
          try {
            ...
            yield Promise.race([loadFont, timeout]);
            return true;
          } catch (e) {
            return false;
          }
      ...
      function loadFontWithFallback(family, style) {
        return __async(this, null, function* () {
          const originalFont = `${family}-${style || "Regular"}`;
          if (yield tryLoadFont(family, style || "Regular")) {
          ...
          if (mapping) {
            ...
            if (yield tryLoadFont(mapping.family, mappedStyle)) {
          ...
          for (const tryStyle of interStyles) {
            if (yield tryLoadFont("Inter", tryStyle)) {
      ...
      function createText(nodeData, parent) {
        return __async(this, null, function* () {
          var _a, _b, _c, _d, _e;
          if (!nodeData.text) {
            return null;
          ...
          let loadedFont;
          try {
            loadedFont = yield loadFontWithFallback(fontFamily, fontStyle);
          } catch (e) {
      ...
      function createVectorFromPath(nodeData, parent) {
        return __async(this, null, function* () {
          var _a, _b;
      ...
      function createRectangle(nodeData, parent) {
        return __async(this, null, function* () {
          var _a, _b, _c;
          if (nodeData.vectorMask && nodeData.vectorMask.pathData) {
            ...
            if (vecImageData) {
              ...
              try {
                createdVecNode = yield createVectorFromPath(nodeData, parent);
            ...
            var vectorNode = yield createVectorFromPath(nodeData, parent);
