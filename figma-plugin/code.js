  ...
  var require_code = __commonJS({
    "figma-plugin/code.ts"() {
      ...
      async function createMaskedNode(nodeData, parent) {
        ...
        const contentNodeData = __spreadProps(__spreadValues({}, nodeData), { mask: void 0 });
      ...
      async function createText(nodeData, parent) {
        ...
        const hasScale = ((_e = nodeData.textTransform) == null ? void 0 : _e.scaleX) && nodeData.textTransform.scaleX !== 1 || ((_f = nodeData.textTransform) == null ? void 0 : _f.scaleY) && nodeData.textTransform.scaleY !== 1;
        ...
        text.x = nodeData.x;
        text.y = nodeData.y;
        if ((_g = nodeData.textTransform) == null ? void 0 : _g.rotation) {
    ...
    <path d="${pathData}" fill="${fillColor}" fill-opacity="${fillOpacity}"${strokeAttr}/>
      ...
      async function createRectangle(nodeData, parent) {
        var _a, _b, _c, _d;
        if ((_a = nodeData.vectorMask) == null ? void 0 : _a.pathData) {
        ...
        if (!hasImage) {
          ...
          if ((_b = nodeData.effects) == null ? void 0 : _b.solidFill) {
          ...
          if ((_c = nodeData.effects) == null ? void 0 : _c.gradientOverlay) {
        ...
        if (((_d = nodeData.effects) == null ? void 0 : _d.stroke) && !nodeData.vectorStroke) {
